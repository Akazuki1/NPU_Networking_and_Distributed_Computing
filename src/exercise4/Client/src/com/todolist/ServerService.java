 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://www.todolist.com", wsdlLocation = "http://127.0.0.1:8001/webservice/todolist?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://www.todolist.com", "ServerService");
    ...
    public Todolist getPort() {
        return super.getPort(new QName("http://www.todolist.com", "port"), Todolist.class);
    }
     ...
     */
    @WebEndpoint(name = "port")
    public Todolist getPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.todolist.com", "port"), Todolist.class, features);
    }
